...
function dpte_timetable2_date_component_shortcode($atts) {
  ...
  $atts = shortcode_atts($default_atts, $atts, 'dpte_timetable2_date_component');
  ...
  ob_start();
  ?>
  <div class="dpte-timetable2-date-component" style="<?php echo esc_attr($style); ?>" <?php echo $data_attrs; ?>>
