...
function dpte_timetable2_prayer_time_component_shortcode($atts) {
  ...
  $atts = shortcode_atts($default_atts, $atts, 'dpte_timetable2_prayer_time_component');
  ...
  $style_keys = array(
    ...
    'timetable2_prayer_grid_non_active_opacity',
  ...
  ob_start();
  ?>
  <div class="dpte-timetable2-prayer-time-component<?php echo $activeclass; ?>" style="<?php echo esc_attr($style); ?>" <?php echo $data_attrs; ?>>
    <?php
      if ($prayer === 'fajr') {
        ?>
