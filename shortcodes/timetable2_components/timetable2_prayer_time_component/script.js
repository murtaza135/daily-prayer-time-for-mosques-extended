class Timetable2PrayerTimeComponent {
  static setPrayerTimes() {
    ["today", "tomorrow", "next"].forEach((timeType) => {
      ...
      rootTimetableElement.forEach((root) => {
        ...
        const zuhrPrayerTitle = root.querySelector(".dpte-timetable2-prayer-time-component .dpte-timetable2-zuhr .dpte-prayer-title");
  ...
  static setActivePrayer() {
    ...
    const currentPrayerElement = Timetable2PrayerTimeComponent.getPrayerElement(extractedPrayerName);
