  ...
  static setPrayerTimes() {
    ["today", "tomorrow", "next"].forEach((timeType) => {
      ...
      rootTimetableElement.forEach((root) => {
        ...
        const sunriseElement = root.querySelector(".dpte-timetable .dpte-timetable-sunrise .dpte-prayer-prayer");
        ...
        const jumahElement = root.querySelector(".dpte-timetable .dpte-timetable-jumah .dpte-prayer-prayer");
