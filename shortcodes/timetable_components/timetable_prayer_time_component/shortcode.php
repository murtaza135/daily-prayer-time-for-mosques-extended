...
function dpte_timetable_prayer_time_component_shortcode($atts) {
  ...
  if ($prayer === 'fajr') {
    ?>
      <div class="dpte-timetable-prayer-time-component dpte-timetable-prayer-time-component-fajr" <?php echo $data_attrs; ?>>
        <span>
          <svg class="dpte-prayer-icon" viewBox="0 0 64 64" fill="#000" stroke="#000">
    ...
    ?>
      <div class="dpte-timetable-prayer-time-component dpte-timetable-prayer-time-component-sunrise" <?php echo $data_attrs; ?>>
        <span>
          <svg class="dpte-prayer-icon" viewBox="0 0 64 64" fill="#000" stroke="#000">
    ...
    ?>
      <div class="dpte-timetable-prayer-time-component dpte-timetable-prayer-time-component-zuhr" <?php echo $data_attrs; ?>>
        <span>
          <svg class="dpte-prayer-icon" viewBox="0 0 64 64" fill="#000" stroke="#000">
    ...
    ?>
      <div class="dpte-timetable-prayer-time-component dpte-timetable-prayer-time-component-asr" <?php echo $data_attrs; ?>>
        <span>
          <svg class="dpte-prayer-icon" viewBox="0 0 64 64" fill="#000" stroke="#000">
    ...
    ?>
      <div class="dpte-timetable-prayer-time-component dpte-timetable-prayer-time-component-maghrib" <?php echo $data_attrs; ?>>
        <span>
          <svg class="dpte-prayer-icon" viewBox="0 0 64 64" fill="#000" stroke="#000">
    ...
    ?>
      <div class="dpte-timetable-prayer-time-component dpte-timetable-prayer-time-component-isha" <?php echo $data_attrs; ?>>
        <span>
          <svg class="dpte-prayer-icon" stroke-width="1.5" viewBox="0 0 24 24" fill="#000" stroke="#000"
    ...
    ?>
      <div class="dpte-timetable-prayer-time-component dpte-timetable-prayer-time-component-jumah" <?php echo $data_attrs; ?>>
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" class="dpte-prayer-icon" viewBox="0 0 200 200" fill="#000">
